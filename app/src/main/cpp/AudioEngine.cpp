...
bool AudioEngine::connectStream(const std::string& host, int port, const std::string& mount, const std::string& pass,
                                 int bitrateKbps, int protocol, const std::string& stationName) {
    return mStreamer.connectStream(host, port, mount, pass, bitrateKbps, protocol, stationName);
}
